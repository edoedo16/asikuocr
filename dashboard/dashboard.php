                    ...
                    <div class="table-responsive">
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            <tbody class="text-center">
                                <?php
                                $tgl = date('Y-m');
                                $tamuall = mysqli_query($conn, "SELECT * FROM bukutamu WHERE tanggal LIKE '%$tgl%' ORDER BY id_bukutamu DESC");
                                ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="example2" class="table table-striped table-bordered">
                                    ...
                                    <tbody class="text-center">
                                        <?php $semuatamu = mysqli_query($conn, "SELECT * FROM `bukutamu` ORDER BY `id_bukutamu` "); ?>
                                        <?php $nomor = 1; ?>
                                        <?php foreach ($semuatamu as $row) : ?>
                                            <tr>
                                                ...
                                                <td><button type="submit" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusModal<?= $nomor; ?>"><i class="bx bx-trash-alt me-0"></i></button></td>
                                            </tr>
